          ...
          <nav class="flex h-9 items-center justify-between" aria-label="Global">
            <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
              <a href="#" class="-m-1.5 p-1.5">
                <span class="sr-only">あれこれ株式会社</span>
            ...
            <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end">
              <a href="/login" class="inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-gray-900 shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20 mx-3">ログイン</a>
              <a href="/signup" class="inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-gray-900 shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20">新規登録</a>
            </div>
          </nav>
            ...
            <DialogPanel focus="true" class="fixed inset-0 z-10 overflow-y-auto bg-white px-6 py-6 lg:hidden">
              ...
              <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                  ...
                  <div class="py-6">
                    <a href="/login" class="-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-6 text-gray-900 hover:bg-gray-400/10">ログイン</a>
                    <a href="/signup" class="-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-6 text-gray-900 hover:bg-gray-400/10">新規登録</a>
                </div>
                </div>
              </div>
            </DialogPanel>
              ...
              <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div class="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                  <span class="text-gray-600">
                    弊社に興味ある方は <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true" /> こちら <span aria-hidden="true">&rarr;</span></a>
                  </span>
                </div>
              </div>
              <div>
                <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">あれこれがあなたの問題を解決</h1>
                <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">この世はあれこれとそれこれでできている</p>
